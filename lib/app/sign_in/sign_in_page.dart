...
import 'package:time_tracker_project/app/sign_in/email_sign_in_page.dart';
import 'package:time_tracker_project/app/sign_in/sign_in_manager.dart';
  ...
  static Widget create(BuildContext context) {
    ...
    return ChangeNotifierProvider<ValueNotifier<bool>>(
      ...
      child: Consumer<ValueNotifier<bool>>(
        builder: (context, isLading, child) => Provider<SignInManager>(
